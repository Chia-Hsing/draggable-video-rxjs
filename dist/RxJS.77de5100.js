...
(0, rxjs_1.fromEvent)(document, 'scroll').pipe((0, rxjs_1.map)(function (_event) {
  return anchor.getBoundingClientRect().bottom < 0;
})).subscribe(function (isBottom) {
  if (isBottom) video.classList.add('video-fixed');else video.classList.remove('video-fixed');
});
var mouseDown = (0, rxjs_1.fromEvent)(video, 'mousedown');
var mouseUp = (0, rxjs_1.fromEvent)(document, 'mouseup');
var mouseMove = (0, rxjs_1.fromEvent)(document, 'mousemove');
...
mouseDown.pipe((0, rxjs_1.filter)(function (_event) {
  return video.classList.contains('video-fixed');
})).pipe((0, rxjs_1.map)(function (_event) {
  return mouseMove.pipe((0, rxjs_1.takeUntil)(mouseUp));
}), (0, rxjs_1.concatAll)()).pipe((0, rxjs_1.withLatestFrom)(mouseDown, function (move, down) {
  return {
...
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/RxJS.77de5100.js.map